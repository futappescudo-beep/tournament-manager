...
export async function archiveTournament(id: string) { await SettingsService.archiveTournament(tournamentIdSchema.parse(id)); revalidatePath("/settings"); revalidatePath("/matches"); revalidatePath("/dashboard"); }
