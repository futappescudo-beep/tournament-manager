...
Versión de documentación: **0.2.28**. La aplicación está en una etapa funcional de operación asistida: el núcleo del torneo está implementado, mientras que automatizaciones y algunos módulos administrativos siguen pendientes.
...
| Planillas / documentos | Pendiente | No existe carga de PDF o imagen de planilla. |
...
La base debe incluir las migraciones de `database/migrations` en orden. Para la versión actual son imprescindibles las migraciones `20260908` a `20260915`, en especial las vistas de fixture/posiciones y el estado `PLAYED`.
