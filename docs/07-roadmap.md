...
1. Verificar en Supabase las migraciones hasta `20260929_guest_competition_filters.sql` y el deploy de Vercel del commit vigente.
...
1. Ejecutar y registrar la matriz de aceptación de roles. Revisar específicamente RLS del delegado y la operación de la cuenta arbitral compartida. Es el bloqueo principal antes de abrir la operación a terceros.
