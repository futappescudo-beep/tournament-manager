...
import type { CategorySetup, TeamDelegateAssignment, TeamSetup, TournamentOption } from "@/lib/service/settings.service";
...
import { FixtureResources } from "./fixture-resources";
import { TeamDelegateManagement } from "./team-delegate-management";

export function TournamentSettingsClient({ tournaments: initialTournaments, categories: initialCategories, profiles, roles, fields, referees, teams, delegateAssignments }: { tournaments: TournamentOption[]; categories: CategorySetup[]; profiles: ProfileOption[]; roles: RoleOption[]; fields: { id: string; name: string }[]; referees: { id: string; first_name: string; last_name: string }[]; teams: TeamSetup[]; delegateAssignments: TeamDelegateAssignment[] }) {
