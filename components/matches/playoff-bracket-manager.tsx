...
const emptyMatch = (stageName: PlayoffStage = "Cuartos de final"): DraftMatch => ({ stageName, homeTeamRegistrationId: "", awayTeamRegistrationId: "", homeSourceLabel: "", awaySourceLabel: "", isNeutralVenue: stageName === "Final", isFinal: stageName === "Final" });
...
export function PlayoffBracketManager({ setup, brackets = [], compact = false }: { setup: FixtureSetup; brackets?: PlayoffBracketSummary[]; compact?: boolean }) {
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      toast.success("Cuadro guardado y cruces completos publicados en el fixture.");
      setOpen(false); reset();
