  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      await createManualFixtureMatch({
        ...
        supervisorRefereeId: String(form.get("supervisorRefereeId") ?? ""),
