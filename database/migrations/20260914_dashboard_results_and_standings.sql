...
with competition_scopes as (
  ...
  select
    ...
    count(*) filter (where home_score > away_score)::integer as won,
    count(*) filter (where home_score = away_score)::integer as drawn,
    count(*) filter (where home_score < away_score)::integer as lost,
  ...
  select
    ...
    competition_phase_id,
    count(*)::integer as played,
    count(*) filter (where away_score > home_score)::integer as won,
    count(*) filter (where away_score = home_score)::integer as drawn,
    count(*) filter (where away_score < home_score)::integer as lost,
